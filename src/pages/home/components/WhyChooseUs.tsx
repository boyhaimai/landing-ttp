  ...
  const features = [
    {
      ...
      description: "Khảo sát thực tế & xác định khách hàng mục tiêu. Định vị phong cách & concept villa phù hợp xu hướng thị trường. Tư vấn cải tạo, decor, setup dịch vụ chuẩn 4–5★"
    },
    {
      icon: "ri-user-settings-line",
      title: "Vận hành & Quản lý chuyên nghiệp",
      description: "Quản lý toàn bộ lịch đặt – check-in/out – dọn dẹp – bảo dưỡng. Đội ngũ nhân sự giàu kinh nghiệm, làm việc 24/7. Đảm bảo trải nghiệm khách hàng nhất quán, nâng cao review & rating online"
    },
    {
      icon: "ri-megaphone-line",
      title: "Marketing & Bán phòng hiệu quả",
      description: "Đăng bán & tối ưu hiển thị trên các nền tảng: Airbnb, Booking, Traveloka, Agoda. Chạy quảng cáo chuyên biệt (Facebook, TikTok, Google) theo từng mùa du lịch. Đội ngũ media sản xuất hình ảnh, video review & quản lý nội dung chuyên nghiệp"
    },
    {
      icon: "ri-bar-chart-line",
      title: "Báo cáo & Chia sẻ doanh thu minh bạch",
      description: "Theo dõi booking, doanh thu, chi phí theo thời gian thực. Báo cáo tự động gửi định kỳ cho chủ đầu tư. Chính sách chia sẻ lợi nhuận linh hoạt & minh bạch, ưu tiên quyền lợi chủ villa"
    }
  ];
    ...
    <div className="md:px-[40px] px-[16px] md:py-[80px] py-[40px] max-w-screen-2xl mx-auto relative">
      ...
      <div className="flex lg:flex-row flex-col items-start justify-between gap-8 pt-[40px]">
        <AnimatedSection className="flex flex-shrink-0 items-center gap-3">
          ...
          <span className="text-[16px] font-medium leading-[1.5] text-gray-600">Giải pháp toàn diện cho chủ villa</span>
        </AnimatedSection>
        ...
        <div className="lg:w-[72%] flex flex-col gap-[40px]">
          <AnimatedSection delay={200}>
            <div className="md:text-[60px] text-[40px] leading-[1.1] font-semibold whitespace-break-spaces text-black">
              <div>Trường Thành Phát Travel - Giải pháp quản lý & vận hành villa nghỉ dưỡng toàn diện</div>
            </div>
          </AnimatedSection>
