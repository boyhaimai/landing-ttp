  ...
  return (
    <div className="px-[16px] max-w-screen-2xl mx-auto md:h-[90vh] relative md:py-[80px] md:mt-[100px] py-[144px]">
      <div className="absolute top-0 left-0 w-full h-full">
        ...
        <AnimatedSection delay={200} className="lg:w-[35vh] max-w-[330px] w-[160px] absolute lg:top-[10%] top-[20px] left-[1%]">
          <img 
            src={img}
            alt="Villa cao cấp 1" 
        ...
        <AnimatedSection delay={400} className="lg:w-[34vh] max-w-[320px] w-[165px] absolute lg:top-0 top-[60px] right-[0]">
          <img 
            src={img1}
            alt="Villa cao cấp 2" 
            className="w-full h-auto"
        ...
        <AnimatedSection delay={600} className="lg:w-[40vh] max-w-[370px] w-[190px] absolute lg:bottom-[15%] bottom-[35px] left-0">
          <img 
            src={img2}
            alt="Villa cao cấp 3" 
            className="w-full h-auto"
        ...
        <AnimatedSection delay={800} className="lg:w-[30vh] max-w-[310px] w-[135px] absolute lg:bottom-[24%] bottom-0 lg:right-[4%] right-[10px]">
          <img 
            src={img3}
            alt="Villa cao cấp 4" 
            className="w-full h-auto"
      ...
      <div className="flex flex-col gap-[32px] justify-center items-center text-center max-w-[490px] mx-auto h-full z-10 relative">
        ...
        <AnimatedSection delay={300} className="md:text-[18px] text-[16px] leading-[1.5] text-gray-600">
          Từ villa đơn lẻ đến chuỗi biệt thự nghỉ dưỡng cao cấp, Trường Thành Phát Travel đã giúp hàng chục chủ đầu tư tối ưu vận hành – tăng doanh thu – nâng tầm giá trị bất động sản.
        </AnimatedSection>
        ...
        <AnimatedSection delay={500}>
          ...
          >
            ...
            <span className="pr-[20px] z-10 group-hover:text-white group-focus:text-white transition-colors font-semibold whitespace-nowrap">Liên hệ Trường Thành Phát</span>
          </button>
        </AnimatedSection>
      </div>
    </div>
